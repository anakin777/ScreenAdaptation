...
package cn.lxl.screenadaptation;
...
public class Builder {
     ...
     * 要产生多少组数据 1 - 500
     */
    private static final int TAGGET_COUNT = 750;
    /**
     * 标准分辨率 按照360 为最基础的
     * 即：values-sw360dp 下面dimen.xml 是 1 - 500 一直是相等的
     * 其他的文件按照比率（计算）来修改
     */
    private static final float STANDARD_DENSITY = 375f;
    /**
     * 生成文件夹的名字
     */
    ...
    private static final int[] SUPPORT_DIMESION = new int[]{
            240,300,310, 320,330,340,350, 360,370,380, 384, 392, 400, 411, 420, 430,440,450, 480, 520, 560, 600, 640, 682, 768, 800, 820
    };
